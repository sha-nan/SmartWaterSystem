...
* @{
*/
#define PRODUCT_KEY "96f704af0f24476f9c07592ef1912e92"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "030c3c3501684dceac890933d45e33e0"
...
* @{
*/
#define OxygenMotor_OnOff_BYTEOFFSET                    0
#define OxygenMotor_OnOff_BITOFFSET                     0
#define OxygenMotor_OnOff_LEN                           1
#define WaterMotor_OnOff_BYTEOFFSET                    0
#define WaterMotor_OnOff_BITOFFSET                     1
#define WaterMotor_OnOff_LEN                           1
#define solenoid_valve_BYTEOFFSET                    0
#define solenoid_valve_BITOFFSET                     2
#define solenoid_valve_LEN                           1
#define SolenoidValve_Water_BYTEOFFSET                    0
#define SolenoidValve_Water_BITOFFSET                     3
#define SolenoidValve_Water_LEN                           1
#define SolenoidValve_Soil_BYTEOFFSET                    0
#define SolenoidValve_Soil_BITOFFSET                     4
#define SolenoidValve_Soil_LEN                           1
#define LiquidLevel_Low_BYTEOFFSET                    1
#define LiquidLevel_Low_BITOFFSET                     0
#define LiquidLevel_Low_LEN                           1
#define LiquidLevel_High_BYTEOFFSET                    1
#define LiquidLevel_High_BITOFFSET                     1
#define LiquidLevel_High_LEN                           1

#define SoilHumidity_RATIO                         1
#define SoilHumidity_ADDITION                      0
#define SoilHumidity_MIN                           0
#define SoilHumidity_MAX                           100
/**@} */
...
typedef enum
{
  ...
  EVENT_OxygenMotor_OnOff,
  EVENT_WaterMotor_OnOff,
  EVENT_solenoid_valve,
  EVENT_SolenoidValve_Water,
  EVENT_SolenoidValve_Soil,
...
typedef struct {
  bool valueOxygenMotor_OnOff;
  bool valueWaterMotor_OnOff;
  bool valuesolenoid_valve;
  bool valueSolenoidValve_Water;
  bool valueSolenoidValve_Soil;
  bool valueLiquidLevel_Low;
  bool valueLiquidLevel_High;
  uint32_t valueSoilHumidity;
} dataPoint_t;


/** Corresponding to the protocol "4.10 WiFi module control device" in the flag " attr_flags" */ 
typedef struct {
  uint8_t flagOxygenMotor_OnOff:1;
  uint8_t flagWaterMotor_OnOff:1;
  uint8_t flagsolenoid_valve:1;
  uint8_t flagSolenoidValve_Water:1;
  uint8_t flagSolenoidValve_Soil:1;
} attrFlags_t;
